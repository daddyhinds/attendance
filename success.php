<?php 
    ...
    if(isset($_POST['submit'])){
       ...
       if($isSuccess){
          // SendEmail::SendMail($email,'Welcome to IT Conference 2021','You have successfully registered for this years\'s IT Conference');
...
<!-- This Prints out values passed to the action page using the method 'get'
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            ...
            <p class="card-text">
                ...
                <p class="card-text">
                Contact Number: <?php //echo $_GET['phone']; ?></p>
...
<div class="card" style="width: 18rem;">
        <div class="card-body">
            ...
            <p class="card-text">
                ...
                <p class="card-text">
                Contact Number: <?php echo $_POST['phone']; ?></p>
